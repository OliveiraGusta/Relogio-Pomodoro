...
class RelogioPomodoro:
    def __init__(self):
        ...
        self.fixar_janela_var = tk.BooleanVar()
        self.fixar_janela_var.set(False)
        self.fixar_janela_button = ttk.Checkbutton(button_frame, text="Fixar", style="info", variable=self.fixar_janela_var, command=self.fixar_janela)
        self.fixar_janela_button.pack(side=tk.LEFT, padx=5)
    ...
    def fixar_janela(self):
        estado_fixo = self.fixar_janela_var.get()
        self.root.attributes('-topmost', estado_fixo)
